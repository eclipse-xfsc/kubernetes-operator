...
import (
	...
	xsfcresourceoperator "github.com/eclipse-xfsc/kubernetes-operator/cmd/apigen"
...
func main() {
	...
	{
		inventorySvc = xsfcresourceoperator.NewInventory()
	}
	...
	)
	{
		...
		inventoryEndpoints.Use(log.Endpoint)
	}
	...
	case "localhost":
		{
			...
			handleHTTPServer(ctx, u, inventoryEndpoints, &wg, errc, *dbgF)
		}
