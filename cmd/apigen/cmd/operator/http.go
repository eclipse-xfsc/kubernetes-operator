...
import (
	...
	inventorysvr "github.com/eclipse-xfsc/kubernetes-operator/cmd/apigen/gen/http/inventory/server"
...
func handleHTTPServer(ctx context.Context, u *url.URL, inventoryEndpoints *inventory.Endpoints, wg *sync.WaitGroup, errc chan error, dbg bool) {
