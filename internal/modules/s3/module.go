...
func (m *Module) CreateResources(ctx context.Context, req modules.CreateResourceRequest) ([]client.Object, error) {
	...
	cm.Labels = map[string]string{"app.kubernetes.io/managed-by": "xsfc-resource-operator", "xfsc.io/generated-for": req.Consumer.Name, "xfsc.io/resource-type": req.Type}
